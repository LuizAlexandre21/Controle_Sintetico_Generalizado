...
####################### Tratando os Dados #####################
########## Importando os dados ##################
local<-"/home/alexandre/Documentos/Controle Sintetico/Painel.xlsx"
dados<-read_xlsx(local)
########## Manipulando os dados #################
dados<-as.data.frame(dados)
dados$Tratamento[is.na(dados$Tratamento)]<-0
